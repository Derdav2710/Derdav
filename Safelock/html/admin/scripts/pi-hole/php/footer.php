    ...
    <footer class="main-footer">
        <div class="row row-centered text-center">
            <div class="col-xs-12 col-sm-6">
                <strong>Thanks for visit our web<a href="" rel="noopener" target="_blank"><i class=""></i> </a></strong>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-10">
                <ul class="<?php echo $list_class; ?>">
                    ...
                    <li>
                        ...
                        <?php if ($docker_update) { ?> &middot; <a class="lookatme" lookatme-text="Update available!" href="<?php echo 
